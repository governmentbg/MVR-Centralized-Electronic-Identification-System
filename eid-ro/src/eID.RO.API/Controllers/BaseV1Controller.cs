...
[SetRequestId]
[ClaimsCheck(Claims.SystemId, Claims.SystemName)]
public class BaseV1Controller : ControllerBase
{
    ...
    protected string GetSystemName() =>
        HttpContext.User.Claims.First(d => d.Type == Claims.SystemName).Value;
    protected string GetSystemId() =>
        HttpContext.User.Claims.First(d => d.Type == Claims.SystemId).Value;
