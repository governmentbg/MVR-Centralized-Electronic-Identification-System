...
@Component
public class ExistingCertificateVerificationStep extends Step<AbstractApplication> {
    ...
    public AbstractApplication process(AbstractApplication application) {
        log.info("Application with id: {} entered ExistingCertificateVerificationStep", application.getId());
        ...
        revokeCertificateInEjbca(
                ...
                new BigInteger(certificate.getSerialNumber()).toString(16)
        );
