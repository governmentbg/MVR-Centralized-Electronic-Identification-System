    ...
    constructor(private translocoService: TranslocoService, private appConfigService: AppConfigService) {
        this.languageChangeSubscription = translocoService.langChanges$.subscribe(() => {
            this.statusOfPrivateSystems = [
                ...
                {
                    address: this.appConfigService.config.systemProcesses?.keycloak_internal,
                    description: this.translocoService.translate('modules.systemProcesses.descriptions.keycloak_internal'),
                },
                {
                    address: this.appConfigService.config.systemProcesses?.keycloak_external,
                    description: this.translocoService.translate('modules.systemProcesses.descriptions.keycloak_external'),
                },
            ];
