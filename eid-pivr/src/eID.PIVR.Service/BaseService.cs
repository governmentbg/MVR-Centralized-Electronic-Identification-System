...
public class BaseService
{
    ...
    protected static ServiceResult<T> NotFound<T>(params (string fieldName, object value)[] data)
    {
        if (data is null)
        {
        ...
        {
            StatusCode = HttpStatusCode.NotFound,
            Errors = data.Select(f =>
                new KeyValuePair<string, string>(f.fieldName, $"'{f.value}' not found")
            ).ToList()
        };
    }
    
    protected static ServiceResult Forbidden(string fieldName, string message)
    {
    ...
    protected static ServiceResult<T> Forbidden<T>(string fieldName, string message)
    {
    ...
    protected static ServiceResult<T> Unauthorized<T>(string fieldName, string message)
    {
    ...
    protected static ServiceResult Unauthorized(string fieldName, string message)
    {
