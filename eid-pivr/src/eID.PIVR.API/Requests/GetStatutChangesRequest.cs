...
/// </summary>
public class GetStatutChangesRequest : IValidatableRequest
{
    public virtual IValidator GetValidator() => new GetStatutChangesRequestValidator();
...
internal class GetStatutChangesRequestValidator : AbstractValidator<GetStatutChangesRequest>
{
    public GetStatutChangesRequestValidator()
    {
