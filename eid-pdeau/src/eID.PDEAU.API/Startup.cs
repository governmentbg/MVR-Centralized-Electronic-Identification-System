...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Title = "eID - PDEAU HTTP API",
                Version = "v1",
                Description = "Подсистема за доставчици на електронни административни услуги (ПДЕАУ)"
            });
