...
public class AdministratorRegisterProviderRequest : RegisterProviderRequest, IValidatableRequest
{
    public virtual IValidator GetValidator() => new AdministratorRegisterProviderRequestValidator();
    public string ExternalNumber { get; set; }
    public IssuerInfoDTO Issuer { get; set; } = new();
}

public class AdministratorRegisterProviderRequestValidator : AbstractValidator<AdministratorRegisterProviderRequest>
{
    public AdministratorRegisterProviderRequestValidator()
    {
        Include(new RegisterProviderRequestValidator());
        RuleFor(r => r.ExternalNumber)
            .NotEmpty()
            .MaximumLength(32);

        RuleFor(r => r.Issuer).NotNull().SetValidator(new IssuerInfoDTOValidator());
    }
}
...
public class IssuerInfoDTOValidator : AbstractValidator<IssuerInfoDTO>
{
    public IssuerInfoDTOValidator()
    {
        RuleFor(r => r.Uid)
            .NotEmpty()
