...
export class EmployeesComponent implements OnInit, OnDestroy {
    ...
    employeeListQuery = new RequestHandler({
        requestFunction: this.centersService.fetchEmployees,
    });
    addEmployeeQuery = new RequestHandler({
        requestFunction: this.centersService.createEmployee,
        onSuccess: res => {
    ...
    editEmployeeQuery = new RequestHandler({
        requestFunction: this.centersService.updateEmployeeById,
        onSuccess: res => {
            this.managerStatusAlertService.checkForPendingAttachments();
            this.loadEmployees();
            this.onClosePreview();
    ...
    deleteEmployeeQuery = new RequestHandler({
        requestFunction: this.centersService.deleteEmployeeById,
        onSuccess: res => {
            this.managerStatusAlertService.checkForPendingAttachments();
            this.loadEmployees();
            this.onClosePreview();
