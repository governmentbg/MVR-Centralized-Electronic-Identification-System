...
export class OfficesComponent implements OnInit {
    ...
    officeListQuery = new RequestHandler({
        requestFunction: this.centersService.fetchOffices,
        onSuccess: res => {
            this.offices = res;
        },
    });
    addOfficeQuery = new RequestHandler({
        requestFunction: this.centersService.createOffice,
        onSuccess: res => {
    ...
    editOfficeQuery = new RequestHandler({
        requestFunction: this.centersService.updateOfficeById,
        onSuccess: res => {
            this.officeListQuery.execute();
            this.onClosePreview();
        },
    ...
    deleteOfficeQuery = new RequestHandler({
        requestFunction: this.centersService.deleteOfficeById,
        onSuccess: res => {
            this.officeListQuery.execute();
            this.onClosePreview();
        },
