...
export const CenterApplicationBasicSchema = z.object({
...
export const CentersPageableSchema = z.object({
    content: z.array(CenterApplicationBasicSchema),
...
export const AttachmentsWithNotesSchema = z.object({
...
export type CenterApplication = z.infer<typeof ApplicationSchema>;
...
const EidFrontOfficeSchema = z.object({
    id: z.string().uuid(),
    name: z.string(),
    region: z.string(),
});
...
export const CenterSchema = z.object({
    ...
    code: z.string(),
    serviceType: z.any(),
    managerStatus: z.nativeEnum(ManagerStatus),
    authorizedPersons: z.array(PersonSchema),
    employeeIds: z.array(z.string()),
    eidManagerFrontOfficeIds: z.array(z.any()),
    attachmentIds: z.array(z.string()),
    noteIds: z.union([z.null(), z.array(z.any())]),
    providedServiceIds: z.array(z.any()),
});
