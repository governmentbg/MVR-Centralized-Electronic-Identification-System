...
import { IEmpowermentXMLRepresentation } from '@app/features/empowerment-check/interfaces/empowerment-check.interfaces';
    ...
    public convertXmlToObject(xmlString: string): IEmpowermentXMLRepresentation {
        ...
        return {
            ...
            volumeOfRepresentation: Array.from(rootNode.getElementsByTagName('Item')).map(itemNode => ({
                id: this.getChildElementValue(itemNode, 'Id'),
