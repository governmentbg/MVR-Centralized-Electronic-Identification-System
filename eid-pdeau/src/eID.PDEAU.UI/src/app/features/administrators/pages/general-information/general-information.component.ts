...
export class GeneralInformationComponent implements OnInit {
    ...
    fetchAdministratorQuery = new RequestHandler({
        requestFunction: this.administratorsService.fetchAdministrator,
        onSuccess: data => {
            this.information = data;
        },
    });
    addRepresentativeQuery = new RequestHandler({
        requestFunction: this.administratorsService.createAuthorizedPerson,
        onSuccess: res => {
            this.managerStatusAlertService.checkForPendingAttachments();
            this.fetchAdministratorQuery.execute();
            this.onClosePreview();
        },
    });
    editRepresentativeQuery = new RequestHandler({
        requestFunction: this.administratorsService.updateAuthorizedPersonById,
        onSuccess: res => {
            this.managerStatusAlertService.checkForPendingAttachments();
            this.fetchAdministratorQuery.execute();
            this.onClosePreview();
    ...
    deleteRepresentativeQuery = new RequestHandler({
        requestFunction: this.administratorsService.deleteAuthorizedPersonById,
        onSuccess: res => {
            this.managerStatusAlertService.checkForPendingAttachments();
            this.fetchAdministratorQuery.execute();
            this.onClosePreview();
    ...
    fetchDocumentsAndNotes = new RequestHandler({
        requestFunction: this.administratorsService.fetchAttachments,
        onSuccess: response => {
