    ...
    constructor(public translateService: TranslocoService) {
        const languageChangeSubscription = translateService.langChanges$.subscribe(() => {
            this.statuses = Object.entries(statuses).map(([key, { translationKey }]) => {
                return {
                    name: this.translateService.translate(`modules.centers.applications.statuses.${translationKey}`),
                    code: key,
                };
            });
            this.applicationTypes = [
                ...
                },
                {
                    ...
                    name: this.translateService.translate(`modules.centers.applications.types.${ApplicationType.STOP}`),
                },
                {
