...
namespace eID.PDEAU.Service.Migrations
{
    ...
    [Migration("20250715135303_EID-9088_Register-done-services")]
    partial class EID9088_Registerdoneservices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eID.PDEAU.Service.Entities.NumberRegister", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "REGNOID",
                            Current = 0,
                            LastChange = new DateOnly(2025, 7, 15)
                        });
                });
            ...
            modelBuilder.Entity("eID.PDEAU.Service.Entities.ProviderDoneService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProviderId", "CreatedOn");

                    b.ToTable("Providers.DoneServises", (string)null);
                });
            ...
            modelBuilder.Entity("eID.PDEAU.Service.Entities.ProviderDoneService", b =>
                {
                    b.HasOne("eID.PDEAU.Service.Entities.Provider", "Provider")
                        .WithMany("DoneServices")
                        .HasForeignKey("ProviderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eID.PDEAU.Service.Entities.ProviderService", "Service")
                        .WithMany("DoneServices")
