...
public class SendPushNotificationValidator : AbstractValidator<SendPushNotification>
{
    public SendPushNotificationValidator()
    {
        ...
        When(r => r.Translations != null, () =>
        {
            ...
            .ForEach(r => r.SetValidator(new PushNotificationTranslationValidator()));
        });
    }
}

public class PushNotificationTranslationValidator : AbstractValidator<PushNotificationTranslation>
{
    public PushNotificationTranslationValidator()
    {
