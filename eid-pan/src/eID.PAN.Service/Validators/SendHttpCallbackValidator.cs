...
public class SendHttpCallbackValidator : AbstractValidator<SendHttpCallbackAsync>
{
    public SendHttpCallbackValidator()
    {
        ...
        When(r => r.Translations != null, () =>
        {
            ...
            .ForEach(r => r.SetValidator(new SendHttpCallbackTranslationValidator()));
        });
    }
}

public class SendHttpCallbackTranslationValidator : AbstractValidator<SendHttpCallbackTranslation>
{
    public SendHttpCallbackTranslationValidator()
    {
