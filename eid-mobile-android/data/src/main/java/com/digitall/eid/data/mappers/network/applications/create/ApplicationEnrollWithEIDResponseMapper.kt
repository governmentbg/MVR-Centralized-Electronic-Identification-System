...
class ApplicationEnrollWithEIDResponseMapper :
    BaseMapper<ApplicationEnrollWithEIDResponse, ApplicationEnrollWithEIDResponseModel>() {

    @Mapper(config = StrictMapperConfig::class)
    fun interface ModelMapper {
        fun map(from: ApplicationEnrollWithEIDResponse): ApplicationEnrollWithEIDResponseModel
    }

    override fun map(from: ApplicationEnrollWithEIDResponse): ApplicationEnrollWithEIDResponseModel {
