...
class CertificateApplicationSignWithEvrotrustUseCase : BaseUseCase {

    companion object {
        private const val TAG = "CertificateApplicationSignWithEvrotrustUseCaseTag"
    }
    ...
    private suspend fun sendSignature(
        ...
        applicationCreateNetworkRepository.sendCertificateApplication(
