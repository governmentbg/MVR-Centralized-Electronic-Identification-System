 ...
 **/
package com.digitall.eid.domain.usecase.empowerment.to.me
...
class GetEmpowermentToMeUseCase : BaseUseCase {

    companion object {
        private const val TAG = "GetEmpowermentToMeUseCaseTag"
    }
    ...
    fun invoke(
        ...
        return empowermentNetworkRepository.getEmpowermentToMe(
