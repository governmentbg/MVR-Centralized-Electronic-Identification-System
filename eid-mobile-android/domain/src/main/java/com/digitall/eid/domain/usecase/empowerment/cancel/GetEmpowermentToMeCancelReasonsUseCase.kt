...
class GetEmpowermentToMeCancelReasonsUseCase : BaseUseCase {

    companion object {
        private const val TAG = "GetEmpowermentDisagreementReasonsUseCaseTag"
    }
    ...
    fun invoke(): Flow<ResultEmittedData<List<String>>> = flow {
        ...
        empowermentCancelNetworkRepository.getEmpowermentToMeCancelReasons().onEach { result ->
            result.onLoading {
