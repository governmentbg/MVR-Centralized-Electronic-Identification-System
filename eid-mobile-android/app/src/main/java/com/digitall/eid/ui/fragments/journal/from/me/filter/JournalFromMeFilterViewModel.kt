...
class JournalFromMeFilterViewModel : BaseJournalFilterViewModel() {

    companion object {
        private const val TAG = "JournalFromMeFilterViewModelTag"
    }
    ...
    override fun onBackPressed() {
        ...
        popBackStackToFragment(R.id.journalFromMeFragment)
    }
