package com.digitall.eid.ui.fragments.citizen.change.password.list
...
class ChangeCitizenPasswordAdapter :
    AsyncListDifferDelegationAdapter<ChangeCitizenPasswordAdapterMarker>(DefaultDiffUtilCallback()),
    KoinComponent {
    ...
    init {
        ...
        delegatesManager.apply {
            addDelegate(commonButtonDelegate as AdapterDelegate<MutableList<ChangeCitizenPasswordAdapterMarker>>)
            addDelegate(commonEditTextDelegate as AdapterDelegate<MutableList<ChangeCitizenPasswordAdapterMarker>>)
        }
    }
