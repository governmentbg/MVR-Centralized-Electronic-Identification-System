...
class EmpowermentFromMeDataSource(
    private val filterModel: EmpowermentFilterModel,
    private val sortingModel: EmpowermentSortingModel,
    private val empowermentFromMeUiMapper: EmpowermentFromMeUiMapper,
    private val getEmpowermentFromMeUseCase: GetEmpowermentFromMeUseCase,
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, EmpowermentAdapterMarker> {
        ...
        try {
            val resultFlow = getEmpowermentFromMeUseCase.invoke(
            ...
            return when (finalResult.status) {
                ResultEmittedData.Status.SUCCESS -> {
                    finalResult.model?.let { responseModel ->
                        ...
                        val empowermentsUi =
                            empowermentFromMeUiMapper.mapList(empowermentsApiModels)
