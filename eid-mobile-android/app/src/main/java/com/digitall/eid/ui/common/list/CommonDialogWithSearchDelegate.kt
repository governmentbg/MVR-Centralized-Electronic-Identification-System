...
class CommonDialogWithSearchDelegate :
    ...
    var clickListener: ((model: CommonDialogWithSearchUi) -> Unit)? = null
    var eraseClickListener: ((model: CommonDialogWithSearchUi) -> Unit)? = null

    override fun isForViewType(
        items: MutableList<CommonListElementAdapterMarker>,
        position: Int
    ): Boolean {
        return items[position] is CommonDialogWithSearchUi
    }
    ...
    override fun onBindViewHolder(
        ...
        (holder as ViewHolder).bind(items[position] as CommonDialogWithSearchUi)
    }
    ...
    private inner class ViewHolder(
        ...
        fun bind(model: CommonDialogWithSearchUi) {
