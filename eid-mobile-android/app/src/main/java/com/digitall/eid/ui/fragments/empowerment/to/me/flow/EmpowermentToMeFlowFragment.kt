...
class EmpowermentToMeFlowFragment :
    BaseFlowFragment<FragmentFlowContainerBinding, EmpowermentToMeFlowViewModel>() {

    companion object {
        private const val TAG = "EmpowermentToMeFlowFragmentTag"
    }

    override fun getViewBinding() = FragmentFlowContainerBinding.inflate(layoutInflater)

    override val viewModel: EmpowermentToMeFlowViewModel by viewModel()

    override fun getFlowGraph() = R.navigation.nav_empowerments_to_me
