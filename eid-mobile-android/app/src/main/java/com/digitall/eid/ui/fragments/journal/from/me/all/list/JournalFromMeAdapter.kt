...
class JournalFromMeAdapter :
    PagingDataAdapter<JournalFromMeUi, RecyclerView.ViewHolder>(DefaultDiffUtilCallback()),
    KoinComponent {

    companion object {
        private const val TAG = "JournalFromMeAdapterTag"
    }

    private val journalFromMeDelegate: JournalFromMeDelegate by inject()
    ...
    init {
        ...
        delegatesManager.apply {
            addDelegate(journalFromMeDelegate as AdapterDelegate<List<Any>>)
        }
    }
