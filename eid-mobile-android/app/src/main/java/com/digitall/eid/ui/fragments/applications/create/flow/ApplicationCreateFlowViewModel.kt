...
class ApplicationCreateFlowViewModel : BaseFlowViewModel() {

    companion object {
        private const val TAG = "ApplicationCreateFlowViewModelTag"
    }

    fun getStartDestination(): StartDestination {
        return StartDestination(R.id.applicationCreateIntroFragment)
    }
