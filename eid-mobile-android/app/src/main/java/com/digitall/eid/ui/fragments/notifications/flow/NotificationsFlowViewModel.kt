...
class NotificationsFlowViewModel : BaseFlowViewModel() {

    companion object {
        private const val TAG = "NotificationsFlowViewModelTag"
    }

    fun getStartDestination(): StartDestination {
        return StartDestination(R.id.notificationsPagerFragment)
    }
