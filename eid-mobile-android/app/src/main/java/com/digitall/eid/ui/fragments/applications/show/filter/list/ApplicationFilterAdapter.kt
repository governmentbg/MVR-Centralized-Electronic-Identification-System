 ...
 **/
package com.digitall.eid.ui.fragments.applications.show.filter.list
...
class ApplicationFilterAdapter :
    AsyncListDifferDelegationAdapter<ApplicationsFilterAdapterMarker>(DefaultDiffUtilCallback()),
    KoinComponent {
    ...
    init {
        ...
        delegatesManager.apply {
            addDelegate(commonTitleDelegate as AdapterDelegate<MutableList<ApplicationsFilterAdapterMarker>>)
            addDelegate(commonSpinnerDelegate as AdapterDelegate<MutableList<ApplicationsFilterAdapterMarker>>)
            addDelegate(commonEditTextDelegate as AdapterDelegate<MutableList<ApplicationsFilterAdapterMarker>>)
            addDelegate(commonSeparatorDelegate as AdapterDelegate<MutableList<ApplicationsFilterAdapterMarker>>)
            addDelegate(commonTitleSmallDelegate as AdapterDelegate<MutableList<ApplicationsFilterAdapterMarker>>)
            addDelegate(commonTextFieldDelegate as AdapterDelegate<MutableList<ApplicationsFilterAdapterMarker>>)
            addDelegate(commonDatePickerDelegate as AdapterDelegate<MutableList<ApplicationsFilterAdapterMarker>>)
            addDelegate(commonDoubleButtonDelegate as AdapterDelegate<MutableList<ApplicationsFilterAdapterMarker>>)
            addDelegate(commonDialogWithSearchDelegate as AdapterDelegate<MutableList<ApplicationsFilterAdapterMarker>>)
        }
    }
