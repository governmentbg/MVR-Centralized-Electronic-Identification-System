...
import com.digitall.eid.models.certificates.revoke.CertificateRevokeDeviceTypeEnum
...
class CertificateRevokeFragment :
    BaseFragment<FragmentWithListBinding, CertificateRevokeViewModel>(),
    CertificateRevokeAdapter.ClickListener {

    companion object {
        private const val TAG = "CertificateStopFragmentTag"
    }

    override val viewModel: CertificateRevokeViewModel by viewModels()

    private val adapter: CertificateRevokeAdapter by inject()

    private val args: CertificateRevokeFragmentArgs by navArgs()
    ...
    override fun parseArguments() {
        try {
            val identityTypes = buildMap {
                CertificateRevokeDeviceTypeEnum.entries.map {
    ...
    override fun setupView() {
        binding.toolbar.setTitleText(StringSource(R.string.certificate_revoke_screen_title))
    ...
    private fun setAdapterData(data: List<CertificateRevokeAdapterMarker>) {
