...
class JournalToMeFragment :
    BaseJournalFragment<JournalToMeViewModel>() {

    companion object {
        private const val TAG = "JournalToMeFragmentTag"
    }

    override val viewModel: JournalToMeViewModel by viewModel()
    override val adapter: JournalToMeAdapter by inject()
    ...
    override fun subscribeToLiveData() {
        ...
        viewModel.adapterListLiveData.observe(viewLifecycleOwner) { data ->
            viewLifecycleOwner.lifecycleScope.launchWithDispatcher {
                ...
                adapter.submitData(data as PagingData<JournalToMeUi>)
