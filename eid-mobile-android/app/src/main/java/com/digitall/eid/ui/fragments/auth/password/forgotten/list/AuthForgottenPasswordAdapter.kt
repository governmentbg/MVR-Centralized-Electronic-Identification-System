package com.digitall.eid.ui.fragments.auth.password.forgotten.list
...
class AuthForgottenPasswordAdapter :
    AsyncListDifferDelegationAdapter<AuthForgottenPasswordAdapterMarker>(DefaultDiffUtilCallback()),
    KoinComponent {
    ...
    init {
        ...
        delegatesManager.apply {
            addDelegate(commonButtonDelegate as AdapterDelegate<MutableList<AuthForgottenPasswordAdapterMarker>>)
            addDelegate(commonEditTextDelegate as AdapterDelegate<MutableList<AuthForgottenPasswordAdapterMarker>>)
            addDelegate(commonDisclaimerTextDelegate as AdapterDelegate<MutableList<AuthForgottenPasswordAdapterMarker>>)
        }
    }
