package com.digitall.eid.ui.fragments.certificates.revoke.list
...
class CertificateRevokeAdapter :
    AsyncListDifferDelegationAdapter<CertificateRevokeAdapterMarker>(DefaultDiffUtilCallback()),
    KoinComponent {
    ...
    init {
        ...
        delegatesManager.apply {
            addDelegate(commonTitleDelegate as AdapterDelegate<MutableList<CertificateRevokeAdapterMarker>>)
            addDelegate(commonButtonDelegate as AdapterDelegate<MutableList<CertificateRevokeAdapterMarker>>)
            addDelegate(commonSpinnerDelegate as AdapterDelegate<MutableList<CertificateRevokeAdapterMarker>>)
            addDelegate(commonEditTextDelegate as AdapterDelegate<MutableList<CertificateRevokeAdapterMarker>>)
            addDelegate(commonSeparatorDelegate as AdapterDelegate<MutableList<CertificateRevokeAdapterMarker>>)
            addDelegate(commonTextFieldDelegate as AdapterDelegate<MutableList<CertificateRevokeAdapterMarker>>)
            addDelegate(commonTitleSmallDelegate as AdapterDelegate<MutableList<CertificateRevokeAdapterMarker>>)
            addDelegate(commonDatePickerDelegate as AdapterDelegate<MutableList<CertificateRevokeAdapterMarker>>)
            addDelegate(commonDialogWithSearchDelegate as AdapterDelegate<MutableList<CertificateRevokeAdapterMarker>>)
            addDelegate(commonButtonTransparentDelegate as AdapterDelegate<MutableList<CertificateRevokeAdapterMarker>>)
        }
    }
