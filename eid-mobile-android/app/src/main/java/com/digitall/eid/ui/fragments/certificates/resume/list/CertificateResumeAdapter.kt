package com.digitall.eid.ui.fragments.certificates.resume.list
...
class CertificateResumeAdapter :
    AsyncListDifferDelegationAdapter<CertificateResumeAdapterMarker>(DefaultDiffUtilCallback()),
    KoinComponent {
    ...
    init {
        ...
        delegatesManager.apply {
            addDelegate(commonTitleDelegate as AdapterDelegate<MutableList<CertificateResumeAdapterMarker>>)
            addDelegate(commonButtonDelegate as AdapterDelegate<MutableList<CertificateResumeAdapterMarker>>)
            addDelegate(commonSpinnerDelegate as AdapterDelegate<MutableList<CertificateResumeAdapterMarker>>)
            addDelegate(commonEditTextDelegate as AdapterDelegate<MutableList<CertificateResumeAdapterMarker>>)
            addDelegate(commonSeparatorDelegate as AdapterDelegate<MutableList<CertificateResumeAdapterMarker>>)
            addDelegate(commonTextFieldDelegate as AdapterDelegate<MutableList<CertificateResumeAdapterMarker>>)
            addDelegate(commonTitleSmallDelegate as AdapterDelegate<MutableList<CertificateResumeAdapterMarker>>)
            addDelegate(commonDatePickerDelegate as AdapterDelegate<MutableList<CertificateResumeAdapterMarker>>)
            addDelegate(commonDialogWithSearchDelegate as AdapterDelegate<MutableList<CertificateResumeAdapterMarker>>)
            addDelegate(commonButtonTransparentDelegate as AdapterDelegate<MutableList<CertificateResumeAdapterMarker>>)
        }
    }
