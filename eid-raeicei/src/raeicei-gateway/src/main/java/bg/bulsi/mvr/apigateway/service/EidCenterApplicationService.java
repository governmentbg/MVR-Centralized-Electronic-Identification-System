...
import bg.bulsi.mvr.raeicei.gateway.api.v1.CreateEidCenterApplicationApiDelegate;
...
public class EidCenterApplicationService implements CreateEidCenterApplicationApiDelegate {
    ...
    public Mono<EidCenterApplicationResponseDTO> createEidCenterApplication(EidCenterApplicationDTO eidCenterApplicationDTO, ServerWebExchange exchange) {
        ...
        return eventSender.send(exchange, eidCenterApplicationDTO, AuditEventType.CREATE_ISSUE_APPLICATION, EidCenterApplicationResponseDTO.class, eventPayloadReq, auditRespPayload);
    }
