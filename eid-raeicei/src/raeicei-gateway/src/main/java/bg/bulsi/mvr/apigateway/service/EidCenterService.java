...
import bg.bulsi.mvr.raeicei.gateway.api.v1.EidCenterApiDelegate;
...
public class EidCenterService implements EidCenterApiDelegate {
    ...
    @Override
    public Mono<EidCenterDTO> createEidCenter(EidCenterDTO eidCenterDTO, ServerWebExchange exchange) {
        return eventSender.send(exchange, eidCenterDTO, AuditEventType.CREATE_EID_CENTER, EidCenterDTO.class);
    }
    ...
    @Override
    public Mono<EidCenterDTO> updateEidCenter(String id, EidCenterDTO eidCenterDTO, ServerWebExchange exchange) {
        return eventSender.send(exchange, eidCenterDTO, AuditEventType.UPDATE_EID_CENTER, EidCenterDTO.class);
    }
