...
import bg.bulsi.mvr.raeicei.gateway.api.v1.ChangeCircumstancesApiDelegate;
...
public class ChangeCircumstancesService implements ChangeCircumstancesApiDelegate {
    ...
    @Override
    public Mono<DeviceDTO> createDevice(DeviceDTO deviceDTO, ServerWebExchange exchange) {
        return eventSender.send(exchange, deviceDTO, AuditEventType.CREATE_DEVICE, DeviceDTO.class);
    }

    @Override
    public Mono<DeviceDTO> updateDevice(DeviceDTO deviceDTO, ServerWebExchange exchange) {
