...
import bg.bulsi.mvr.raeicei.extgateway.api.v1.ChangeApplicationStatusApiDelegate;
...
public class ChangeApplicationStatusService implements ChangeApplicationStatusApiDelegate {
    ...
    public Mono<HttpResponse> changeApplicationStatus(UUID id, ApplicationStatus applicationStatus, NoteAndDocumentsDTO noteAndDocumentsDTO, String code, ServerWebExchange exchange) {
        ...
        return eventSender.send(exchange, buildPayload(id, applicationStatus, code, noteAndDocumentsDTO), AuditEventType.CHANGE_EXT_APPLICATION_STATUS, HttpResponse.class, eventPayloadReq, auditRespPayload);
    }
