...
internal class GetLogToUserValidator : AbstractValidator<GetLogToUser>
{
    public GetLogToUserValidator()
    {
        ...
        RuleFor(r => r)
            ...
            .WithMessage($"{nameof(GetLogToUser.StartDate)} must be less than or equal to {nameof(GetLogToUser.EndDate)}.");
    ...
    private bool HasActiveFilter(GetLogToUser r)
    {
