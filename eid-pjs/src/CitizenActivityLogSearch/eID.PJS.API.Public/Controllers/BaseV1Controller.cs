...
public class BaseV1Controller : ControllerBase
{
    ...
    protected string GetUserEid() =>
        HttpContext.User.Claims.FirstOrDefault(d => d.Type == Claims.EidenityId)?.Value ?? string.Empty;
    ...
    protected string? GetSystemName() =>
       HttpContext.User.Claims.FirstOrDefault(d => d.Type == Claims.SystemName)?.Value;
