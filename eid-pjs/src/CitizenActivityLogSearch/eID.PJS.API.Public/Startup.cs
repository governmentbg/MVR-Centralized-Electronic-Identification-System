...
public class Startup
{
    ...
    {
        services.AddOptions<FilterOptions>().BindConfiguration(nameof(FilterOptions));
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Title = "eID - Submodule Journal of Events HTTP API Public",
                Version = "v1",
                Description = "The Submodule Journal of Events Microservice HTTP API Public"
            });
