...
public class GetLogToUserAsCSVRequest : IValidatableRequest
{
    public virtual IValidator GetValidator() => new GetLogToUserAsCSVRequestValidator();
...
internal class GetLogToUserAsCSVRequestValidator : AbstractValidator<GetLogToUserAsCSVRequest>
{
    public GetLogToUserAsCSVRequestValidator()
    {
        ...
        RuleFor(r => r)
            ...
            .WithName($"{nameof(GetLogToUserAsCSVRequest.StartDate)} and {nameof(GetLogToUserAsCSVRequest.EndDate)}");
