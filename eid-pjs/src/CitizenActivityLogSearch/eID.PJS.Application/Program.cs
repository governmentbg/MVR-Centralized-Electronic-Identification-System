using eID.PJS.Application;
//using eID.PJS.Service.Database;
...
{
    public static readonly string Namespace = typeof(Startup).Namespace ?? "eID.PJS.Application";
    public static readonly string ApplicationName = Namespace?.Substring(Namespace.IndexOf('.') + 1) ?? "DefaultApplicationName";
    public static readonly string SystemName = ApplicationName.Split(".").FirstOrDefault() ?? "PJS";
}
