...
/**
 * SendNotificationRequestInput Class Doc Comment
 *
 * @category Class
 * @package  PanSdk
 * @author   OpenAPI Generator team
 ...
 */
class SendNotificationRequestInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendNotificationRequestInput';
    ...
    protected static $openAPITypes = [
        ...
        'e_id' => 'string',
        'uid' => 'string',
        'uid_type' => '\PanSdk\Model\IdentifierType'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('e_id', $data ?? [], null);
    ...
    */
    ...
    public function setEventCode($event_code)
    {
        if (is_null($event_code)) {
            array_push($this->openAPINullablesSetToNull, 'event_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('event_code', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        return $this->container['e_id'];
    }

    /**
     * Sets e_id
     *
     * @param string|null $e_id e_id
     *
     * @return self
     */
    ...
    {
        if (is_null($e_id)) {
            array_push($this->openAPINullablesSetToNull, 'e_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('e_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['e_id'] = $e_id;
     ...
     * Gets uid_type
     *
     * @return \PanSdk\Model\IdentifierType|null
     */
     ...
     * Sets uid_type
     *
     * @param \PanSdk\Model\IdentifierType|null $uid_type uid_type
     *
     * @return self
     */
