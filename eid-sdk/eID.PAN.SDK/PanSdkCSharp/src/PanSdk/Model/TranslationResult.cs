...
namespace PanSdk.Model
{
    ...
    public partial class TranslationResult : IValidatableObject
    {
        /// <summary>
        ...
        public TranslationResult(string language = default, string shortDescription = default, string description = default)
        {
