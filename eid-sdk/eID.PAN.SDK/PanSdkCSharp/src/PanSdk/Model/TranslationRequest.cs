...
namespace PanSdk.Model
{
    ...
    /// TranslationRequest
    /// </summary>
    [DataContract(Name = "TranslationRequest")]
    public partial class TranslationRequest : IValidatableObject
    {
        /// <summary>
        ...
        public TranslationRequest(string language = default, string shortDescription = default, string description = default)
        {
