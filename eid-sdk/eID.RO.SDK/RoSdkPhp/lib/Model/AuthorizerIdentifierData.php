...
/**
 * AuthorizerIdentifierData Class Doc Comment
 *
 * @category Class
 * @package  RoSdk
 * @author   OpenAPI Generator team
 ...
 */
class AuthorizerIdentifierData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorizerIdentifierData';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_issuer', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets is_issuer
     *
     * @param bool|null $is_issuer is_issuer
     *
     * @return self
     */
    public function setIsIssuer($is_issuer)
    {
        if (is_null($is_issuer)) {
            throw new \InvalidArgumentException('non-nullable is_issuer cannot be null');
        }
