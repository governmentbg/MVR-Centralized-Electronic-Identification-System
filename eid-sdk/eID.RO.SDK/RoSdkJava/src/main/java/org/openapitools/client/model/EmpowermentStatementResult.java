...
public class EmpowermentStatementResult {
  ...
  public EmpowermentStatementResult() {
  }

  public EmpowermentStatementResult id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public EmpowermentStatementResult number(@javax.annotation.Nullable String number) {
    this.number = number;
    return this;
  }
  ...
  public EmpowermentStatementResult startDate(@javax.annotation.Nullable OffsetDateTime startDate) {
  ...
  public EmpowermentStatementResult expiryDate(@javax.annotation.Nullable OffsetDateTime expiryDate) {
  ...
  public EmpowermentStatementResult status(@javax.annotation.Nullable EmpowermentStatementStatus status) {
    this.status = status;
    return this;
  }
  ...
  public EmpowermentStatementResult uid(@javax.annotation.Nullable String uid) {
    this.uid = uid;
    return this;
  }
  ...
  public EmpowermentStatementResult uidType(@javax.annotation.Nullable IdentifierType uidType) {
  ...
  public EmpowermentStatementResult name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EmpowermentStatementResult onBehalfOf(@javax.annotation.Nullable OnBehalfOf onBehalfOf) {
  ...
  public EmpowermentStatementResult authorizerUids(@javax.annotation.Nullable List<UidResult> authorizerUids) {
    this.authorizerUids = authorizerUids;
    return this;
  }

  public EmpowermentStatementResult addAuthorizerUidsItem(UidResult authorizerUidsItem) {
  ...
  public EmpowermentStatementResult empoweredUids(@javax.annotation.Nullable List<UidResult> empoweredUids) {
    this.empoweredUids = empoweredUids;
    return this;
  }

  public EmpowermentStatementResult addEmpoweredUidsItem(UidResult empoweredUidsItem) {
  ...
  public EmpowermentStatementResult providerId(@javax.annotation.Nullable String providerId) {
  ...
  public EmpowermentStatementResult providerName(@javax.annotation.Nullable String providerName) {
  ...
  public EmpowermentStatementResult serviceId(@javax.annotation.Nullable Integer serviceId) {
  ...
  public EmpowermentStatementResult serviceName(@javax.annotation.Nullable String serviceName) {
  ...
  public EmpowermentStatementResult volumeOfRepresentation(@javax.annotation.Nullable List<VolumeOfRepresentationResult> volumeOfRepresentation) {
    this.volumeOfRepresentation = volumeOfRepresentation;
    return this;
  }

  public EmpowermentStatementResult addVolumeOfRepresentationItem(VolumeOfRepresentationResult volumeOfRepresentationItem) {
  ...
  public EmpowermentStatementResult createdOn(@javax.annotation.Nullable OffsetDateTime createdOn) {
  ...
  public EmpowermentStatementResult createdBy(@javax.annotation.Nullable String createdBy) {
  ...
  public EmpowermentStatementResult issuerPosition(@javax.annotation.Nullable String issuerPosition) {
  ...
  public EmpowermentStatementResult xmlRepresentation(@javax.annotation.Nullable String xmlRepresentation) {
  ...
  public EmpowermentStatementResult denialReason(@javax.annotation.Nullable EmpowermentsDenialReason denialReason) {
  ...
  public EmpowermentStatementResult empowermentWithdrawals(@javax.annotation.Nullable List<EmpowermentWithdrawResult> empowermentWithdrawals) {
    this.empowermentWithdrawals = empowermentWithdrawals;
    return this;
  }

  public EmpowermentStatementResult addEmpowermentWithdrawalsItem(EmpowermentWithdrawResult empowermentWithdrawalsItem) {
  ...
  public EmpowermentStatementResult empowermentDisagreements(@javax.annotation.Nullable List<EmpowermentDisagreementResult> empowermentDisagreements) {
    this.empowermentDisagreements = empowermentDisagreements;
    return this;
  }

  public EmpowermentStatementResult addEmpowermentDisagreementsItem(EmpowermentDisagreementResult empowermentDisagreementsItem) {
  ...
  public EmpowermentStatementResult statusHistory(@javax.annotation.Nullable List<StatusHistoryResult> statusHistory) {
    this.statusHistory = statusHistory;
    return this;
  }

  public EmpowermentStatementResult addStatusHistoryItem(StatusHistoryResult statusHistoryItem) {
  ...
  public EmpowermentStatementResult calculatedStatusOn(@javax.annotation.Nullable CalculatedEmpowermentStatus calculatedStatusOn) {
  ...
  public boolean equals(Object o) {
    ...
    EmpowermentStatementResult empowermentStatementResult = (EmpowermentStatementResult) o;
    return Objects.equals(this.id, empowermentStatementResult.id) &&
        Objects.equals(this.number, empowermentStatementResult.number) &&
        Objects.equals(this.startDate, empowermentStatementResult.startDate) &&
        Objects.equals(this.expiryDate, empowermentStatementResult.expiryDate) &&
        Objects.equals(this.status, empowermentStatementResult.status) &&
        Objects.equals(this.uid, empowermentStatementResult.uid) &&
        Objects.equals(this.uidType, empowermentStatementResult.uidType) &&
        Objects.equals(this.name, empowermentStatementResult.name) &&
        Objects.equals(this.onBehalfOf, empowermentStatementResult.onBehalfOf) &&
        Objects.equals(this.authorizerUids, empowermentStatementResult.authorizerUids) &&
        Objects.equals(this.empoweredUids, empowermentStatementResult.empoweredUids) &&
        Objects.equals(this.providerId, empowermentStatementResult.providerId) &&
        Objects.equals(this.providerName, empowermentStatementResult.providerName) &&
        Objects.equals(this.serviceId, empowermentStatementResult.serviceId) &&
        Objects.equals(this.serviceName, empowermentStatementResult.serviceName) &&
        Objects.equals(this.volumeOfRepresentation, empowermentStatementResult.volumeOfRepresentation) &&
        Objects.equals(this.createdOn, empowermentStatementResult.createdOn) &&
        Objects.equals(this.createdBy, empowermentStatementResult.createdBy) &&
        Objects.equals(this.issuerPosition, empowermentStatementResult.issuerPosition) &&
        Objects.equals(this.xmlRepresentation, empowermentStatementResult.xmlRepresentation) &&
        Objects.equals(this.denialReason, empowermentStatementResult.denialReason) &&
        Objects.equals(this.empowermentWithdrawals, empowermentStatementResult.empowermentWithdrawals) &&
        Objects.equals(this.empowermentDisagreements, empowermentStatementResult.empowermentDisagreements) &&
        Objects.equals(this.statusHistory, empowermentStatementResult.statusHistory) &&
        Objects.equals(this.calculatedStatusOn, empowermentStatementResult.calculatedStatusOn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmpowermentStatementResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmpowermentStatementResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmpowermentStatementResult is not found in the empty JSON string", EmpowermentStatementResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmpowermentStatementResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmpowermentStatementResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmpowermentStatementResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmpowermentStatementResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmpowermentStatementResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmpowermentStatementResult.class));

       return (TypeAdapter<T>) new TypeAdapter<EmpowermentStatementResult>() {
           @Override
           public void write(JsonWriter out, EmpowermentStatementResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmpowermentStatementResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmpowermentStatementResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmpowermentStatementResult
   * @throws IOException if the JSON string is invalid with respect to EmpowermentStatementResult
   */
  public static EmpowermentStatementResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmpowermentStatementResult.class);
  }

  /**
   * Convert an instance of EmpowermentStatementResult to an JSON string
   *
   * @return JSON string
   */
