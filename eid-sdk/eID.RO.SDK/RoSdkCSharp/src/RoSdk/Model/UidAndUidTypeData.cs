...
namespace RoSdk.Model
{
    ...
    /// UidAndUidTypeData
    /// </summary>
    [DataContract(Name = "UidAndUidTypeData")]
    public partial class UidAndUidTypeData : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UidAndUidTypeData" /> class.
        /// </summary>
        /// <param name="uid">uid.</param>
        /// <param name="uidType">uidType.</param>
        /// <param name="name">name.</param>
        public UidAndUidTypeData(string uid = default, IdentifierType? uidType = default, string name = default)
        {
            this.Uid = uid;
