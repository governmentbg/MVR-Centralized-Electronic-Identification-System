...
export enum EmpowermentsDenialReason {
    ...
    InvalidUidRegistrationStatusDetected = 'InvalidUidRegistrationStatusDetected',
    UidsRegistrationStatusInfoNotAvailable = 'UidsRegistrationStatusInfoNotAvailable',
    RegistrationStatusUnavailable = 'RegistrationStatusUnavailable',
    InactiveProfile = 'InactiveProfile',
    NoBaseProfile = 'NoBaseProfile',
