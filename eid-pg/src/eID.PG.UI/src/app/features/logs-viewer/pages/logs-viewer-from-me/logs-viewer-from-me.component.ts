...
import { IBreadCrumbItems } from '../../../../shared/interfaces/IBreadCrumbItems';
import { ToastService } from 'src/app/shared/services/toast.service';
import { LogsService } from '../../services/logs.service';

@Component({
    selector: 'app-logs-viewer-from-me',
    templateUrl: './logs-viewer-from-me.component.html',
    styleUrls: ['./logs-viewer-from-me.component.scss'],
})
export class LogsViewerFromMeComponent implements OnInit, OnDestroy {
    constructor(
    ...
    loadLogs(logsFilterData?: any, clearLogsData = false): void {
        ...
        this.logsService.getLogsFrom(payload).subscribe({
            next: (response: any) => {
