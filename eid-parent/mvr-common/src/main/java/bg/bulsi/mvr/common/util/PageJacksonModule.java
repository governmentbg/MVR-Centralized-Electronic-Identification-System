...
/*
   copy pasted from org.springframework.cloud.openfeign.support.PageJacksonModule
*/
public class PageJacksonModule extends Module {
    ...
    static class SimplePageImpl<T> implements Page<T>, Serializable {
        @Serial
        private static final long serialVersionUID = 8482275205598932216L;
