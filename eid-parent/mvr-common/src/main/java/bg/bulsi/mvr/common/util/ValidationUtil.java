...
public class ValidationUtil {
    ...
    public static void assertEqualsIgnoreCase(String a, String b, ErrorCode errorCode, Object... params) {
    ...
    public static void assertNotEquals(Object a, Object b, ErrorCode errorCode, Object... params) {
        if (Objects.equals(a, b)) {
            throw new ValidationMVRException(errorCode, params);
        }
    }
    ...
    public static Pageable replaceSortField(Pageable pageable, String field, String replacement) {
        Sort newSort = Sort.unsorted();

        for (Sort.Order order : pageable.getSort()) {
            if (field.equals(order.getProperty())) {
                newSort = newSort.and(Sort.by(order.getDirection(), replacement));
            } else {
