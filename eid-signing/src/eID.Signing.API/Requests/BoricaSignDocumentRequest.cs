...
/// </summary>
public class ARSBoricaSignDocumentRequest : IValidatableRequest
{
    public virtual IValidator GetValidator() => new ARSBoricaSignDocumentRequestValidator();
...
public class BoricaSignDocumentRequest : ARSBoricaSignDocumentRequest
{
...
public class BoricaSignDocumentRequestValidator : AbstractValidator<BoricaSignDocumentRequest>
{
    ...
    {
        Include(new ARSBoricaSignDocumentRequestValidator());
...
public class ARSBoricaSignDocumentRequestValidator : AbstractValidator<ARSBoricaSignDocumentRequest>
{
    public ARSBoricaSignDocumentRequestValidator()
    {
